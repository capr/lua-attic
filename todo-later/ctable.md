---
tagline: cdata-based hash maps
---

## `local ctable = require'ctable'`

A *ctable* is a hash table whose keys and values are cdata values.
...
The table is stored as an open-addressed
...
To create a ctable, call `ctable.new`, for example:
