...
--ACME v2 client protocol.
--Written by Adis Nezirovic. Apache 2.0 License.
--Modified by Cosmin Apreuteseu. Public domain.
--ACME RFC: https://tools.ietf.org/html/draft-ietf-acme-acme-12
